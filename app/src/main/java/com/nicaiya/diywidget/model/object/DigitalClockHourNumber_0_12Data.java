...
public class DigitalClockHourNumber_0_12Data extends TextData implements EditableHeaderFooter {
    private static final boolean DEBUG = false;
    public static final String TAG = DigitalClockHourNumber_0_12Data.class.getSimpleName();
    private static final String SUPER_TAG = DigitalClockHourNumber_0_12Data.class.getSuperclass().getSimpleName();

    private String header = "";
    private String footer = "";

    public DigitalClockHourNumber_0_12Data() {
        setName(ResourceUtil.getString(R.string.digital_clock_hour_number_0_12));
    }
