...
public class ShapeOvalData extends AbsOutlineData implements EditableFillStyle {

    public static final boolean DEBUG = false;
    public static final String TAG = ShapeOvalData.class.getSimpleName();
    private static final String SUPER_TAG = ShapeOvalData.class.getSuperclass().getSimpleName();
    ...
    public ShapeOvalData() {
        setOutLineWidth(4.0f);
        setName(ResourceUtil.getString(R.string.shape_oval));
    }
    ...
    public void draw(Canvas canvas) {
        RectF ovalRect = new RectF(0.0f, 0.0f, getWidth(), getHeight());
        canvas.setMatrix(getMatrix());
        canvas.drawOval(ovalRect, getPaint());
        if (isEnableOutline()) {
            canvas.drawOval(ovalRect, getOutlinePaint());
        }
    }
    ...
    public boolean hitTest(int x, int y) {
        ...
        return getBounds().contains((int) pts[0], (int) pts[0]);
    }
