...
public class DigitalClockHourNumber_0_24Data extends TextData implements EditableHeaderFooter {
    private static final boolean DEBUG = false;
    public static final String TAG = DigitalClockHourNumber_0_24Data.class.getSimpleName();
    private static final String SUPER_TAG = DigitalClockHourNumber_0_24Data.class.getSuperclass().getSimpleName();

    private String header = "";
    private String footer = "";

    public DigitalClockHourNumber_0_24Data() {
        setName(ResourceUtil.getString(R.string.digital_clock_hour_number_0_24));
    }
