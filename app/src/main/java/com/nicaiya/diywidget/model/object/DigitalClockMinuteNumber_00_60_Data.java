...
public class DigitalClockMinuteNumber_00_60_Data extends TextData implements EditableHeaderFooter {
    private static final boolean DEBUG = BuildConfig.DEBUG;
    public static final String TAG = DigitalClockMinuteNumber_00_60_Data.class.getSimpleName();
    private static final String SUPER_TAG = DigitalClockMinuteNumber_00_60_Data.class.getSuperclass().getSimpleName();

    private String header = "";
    private String footer = "";

    public DigitalClockMinuteNumber_00_60_Data() {
