...
public class DigitalClockAMPMTextData extends TextData implements EditableHeaderFooter {
    ...
    public DigitalClockAMPMTextData() {
        setName(ResourceUtil.getString(R.string.digital_clock_am_pm_text));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (Calendar.getInstance().get(Calendar.AM_PM) == Calendar.AM) {
            ampmString = ResourceUtil.getString(R.string.am);
        } else {
            ampmString = ResourceUtil.getString(R.string.pm);
        }
        setText(header + String.valueOf(ampmString) + footer);
        super.draw(canvas);
    }
